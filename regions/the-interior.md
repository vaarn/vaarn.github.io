...
5. Travel routes that connect to even-numbered locations are (relatively) safe. Travel routes between two odd-numbered locations, however, have a hazard associated with them. Consult the table below for inspiration.
